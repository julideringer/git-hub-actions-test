...
from trips.trip_lambda_suggestions import lambda_handler

class TestLambdaHandler(unittest.TestCase):
    @patch("trips.trip_lambda_suggestions.boto3.resource")
    def test_lambda_handler(self, mock_boto3):
        ...
        event = {
            "body-json": {
                "userId": "815830c4-e1c2-43cf-9582-e78f8361f7a6",
                "latitudDeparture": "37.18692862559688",
                "longitudDeparture": "-3.721499145574015"
    }
        }
